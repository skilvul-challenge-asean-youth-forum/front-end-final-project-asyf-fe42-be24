...
const Footer = () => {
  ...
  return (
    <div className="bg-[#237804] border-gray-200 dark:bg-gray-900 text-white">
      <div className="flex flex-wrap justify-between max-w-screen-xl mx-auto items-center p-8">
        <div className="flex flex-col items-start w-full mb-8 xl:w-2/5">
            <img src="https://aseanyouthforum.org/wp-content/uploads/2019/03/cropped-Logo-Asean-Youth-Forum-HR-01.png" alt="asean youth forum" className="h-24 mr-3"/>
            <p>A movement that represents the youth in ASEAN to voice out their concerns and strategise for ways to achieve a better ASEAN Community.</p>
        </div>
